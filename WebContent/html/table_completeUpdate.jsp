									...
									<tbody>
										...
										<tr>
											...
											<td><input class="am-form-field am-u-md-10" type="text"
												readonly="readonly" id="doc-ds-ipt-1" name="stu.id"
												value="${stu.id}"></td>
											<td><input class="am-form-field am-input-sm am-radius"
												name="stu.name" value="${stu.name}" /></td>
											<td><input class="am-form-field am-input-sm am-radius"
												name="stu.nickName" value="${stu.nickName}" /></td>
											<td><input class="am-form-field am-input-sm am-radius"
												name="stu.password" value="${stu.password}" /></td>
											<td><input class="am-form-field am-input-sm am-radius"
												name="stu.age" value="${stu.age}" /></td>
											<td><input class="am-form-field am-input-sm am-radius"
												name="stu.floor" value="${stu.floor}" /></td>
											<td><input class="am-form-field am-input-sm am-radius"
												name="stu.dorm" value="${stu.dorm}" /></td>
											<td><input class="am-form-field am-input-sm am-radius"
												name="stu.sex" value="${stu.sex}" /></td>
											<td>
												<div class="am-btn-toolbar">
													<div class="am-btn-group am-btn-group-xs">
