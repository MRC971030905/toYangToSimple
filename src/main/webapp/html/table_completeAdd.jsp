        ...
        <div class="am-u-sm-12">
            ...
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <form action="add" method="post" enctype="multipart/form-data">
              	<tr>
              		<td><input class="am-form-field am-u-md-10" type="text" readonly="readonly" id="doc-ds-ipt-1" name="d.dId"></td>
              		<td><input class="am-form-field am-input-sm am-radius" name="d.name"  /></td>
              		<td><input class="am-form-field am-input-sm am-radius"  name="d.departmentName"  /></td>
              		<td><input class="am-form-field am-input-sm am-radius"  name="d.className"  /></td>
              		<td><input class="am-form-field am-input-sm am-radius"   name="d.phone"   /></td>
              		<td><input class="am-form-field am-input-sm am-radius"  name="d.tim"   /></td>
              		<td><input class="am-form-field am-input-sm am-radius"   name="d.weChat"  /></td>
              		<td><input class="am-form-field am-input-sm am-radius"  name="d.area"    /></td>
              		<td><input class="am-form-field am-input-sm am-radius"  name="d.dormitory"   /></td>
              		<td><input class="am-form-field am-input-sm am-radius"   name="d.height"   /></td>
              		<td><input class="am-form-field am-input-sm am-radius"  name="d.weight"  /></td> 
